...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
			"User Management 1.0.0: Minimal Kubernetes on AWS with Terraform, or: How I Learned to stop paying for AWS EKS and NAT Gateway, and love the K3S", "Awesome API Description", "1.0",
